            ...
            <div className="row">
              <div className="col-6 col-12-medium">
                ...
                <p>
                  ...
                  text. This is <u>underlined</u>, this is <code>code</code>,
                  and this is a <a href="#react-router-training">link</a>.
                </p>
                ...
                <ul className="icons">
                  ...
                  <li>
                    <a href="#react-router-training" className="icon fa-github">
                  ...
                  <li>
                    <a href="#react-router-training" className="icon fa-tumblr">
                      <span className="label">Tumblr</span>
                    </a>
                  </li>
                  <li>
                    <a href="#react-router-training" className="icon fa-apple">
                  ...
                  <li>
                    <a
                      href="#react-router-training"
                      className="icon fa-windows"
                    >
                      <span className="label">Windows</span>
                    </a>
                  </li>
                  <li>
                    <a href="#react-router-training" className="icon fa-500px">
                ...
                <ul className="actions">
                  <li>
                    <a href="#react-router-training" className="button primary">
                      Default
                    </a>
                  </li>
                  <li>
                    <a href="#react-router-training" className="button">
                      Default
                    </a>
                  </li>
                </ul>
                <ul className="actions">
                  ...
                  <li>
                    <a href="#react-router-training" className="button small">
                      Small
                    </a>
                  </li>
                </ul>
                <div className="row">
                  ...
                  <div className="col-3 col-12-small">
                    <ul className="actions stacked">
                      ...
                      <li>
                        <a href="#react-router-training" className="button fit">
                          Default
                        </a>
                      </li>
                    </ul>
              ...
              <div className="col-6 col-12-medium">
                ...
                <ul className="actions">
                  ...
                  <li>
                    <a href="#react-router-training" className="button wide">
                      Wide
                    </a>
                  </li>
                </ul>
                ...
                <ul className="actions">
                  <li>
                    <a
                      href="#react-router-training"
                      className="button primary icon fa-search"
                    >
                      Icon
                    </a>
                  </li>
                ...
                <form method="post" action="#">
                  <div className="row gtr-uniform">
                    ...
                    <div className="col-4 col-12-small">
                      <input type="radio" id="radio-alpha" name="radio" />
                ...
                <p>
                  ...
                  felis sagittis eget. tempus euismod. Magna et cursus lorem
                  ...
                  adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu
                  faucibus. Integer ac sed amet praesent. Nunc lacinia ante nunc
                  ac gravida lorem ipsum dolor sit amet dolor feugiat consequat.
                </p>
                <p>
