          ...
          <div className="highlights">
            <section>
              <div className="content">
                <header>
                  <a href="#react-router-training" className="icon fa-vcard-o">
            ...
            <section>
              <div className="content">
                <header>
                  <a href="#react-router-training" className="icon fa-files-o">
                    <span className="label">Icon</span>
                  </a>
            ...
            <section>
              <div className="content">
                <header>
                  <a href="#react-router-training" className="icon fa-floppy-o">
                    <span className="label">Icon</span>
                  </a>
            ...
            <section>
              <div className="content">
                <header>
                  <a href="#react-router-training" className="icon fa-qrcode">
                    <span className="label">Icon</span>
                  </a>
